...
class KuCoinWebSocket:
    ...
    def __init__(self, api_key: str = None, api_secret: str = None, passphrase: str = None, 
                 market_type: str = "futures", verbose: bool = False, callback = None):
        """
        ...
        Args:
            ...
            callback: Eine optionale Callback-Funktion für empfangene Daten
        """
    ...
    def on_message(self, ws, message):
        ...
        try:
            ...
            # Ausgabe der Rohdaten wenn verbose
            if self.verbose:
