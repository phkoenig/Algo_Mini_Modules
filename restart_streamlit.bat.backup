...
start "Streamlit App" cmd /k "title Streamlit App && color 0B && cd /d %~dp0 && call venv\Scripts\activate.bat && echo Streamlit wird gestartet... && echo. && python -m streamlit run gui/login.py --server.port 8501"
